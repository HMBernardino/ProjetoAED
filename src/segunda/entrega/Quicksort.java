...
public final class Quicksort {
    ...
    public static <Item extends Comparable<? super Item>> void sort(
        ...
        if (length <= cutoff) {
            ...
            int positionOfMedian = positionOfMedianOf3(values, first,
                    first + length / 2, last);
            ...
            final int positionOfMedian2 = positionOfMedianOf3(values,
                    middle - spacing, middle, middle + spacing);
            final int positionOfMedian3 = positionOfMedianOf3(values,
                    last - spacing - spacing, last - spacing, last);
